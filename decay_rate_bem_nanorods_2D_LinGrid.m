...
%  nanorod geometries
mesh = [ 31, 41, 31]; % n1 for the circumference of the rod, n2 for the polar angles of the rod caps, n3 for the cylinder-shaped middle part of the rod
height =  70   ;
diameter =  30  ;
...
x_mesh = round ( height/2 + 50 );
z_mesh = round ( diameter/2 + 50 );

% calculate a quarter of a full nanorod
[ x, z ] = meshgrid( linspace( 0, x_mesh, x_mesh ), linspace( 0, z_mesh, z_mesh ) );
